...
public class GetContent {
	...
	private static void disableSslVerification() {
		try {
			...
			GetContent.LOGGER.log(Level.SEVERE, e.getMessage());
	...
	public static void getContent1(URL sourceUrl, File outFile) throws IOException {
		// To read the file from our URL, we'll create a new ReadableByteChannel from
		// the URL stream:
	...
	/*
	 * A Jersey implementation of an http client uso la classe
