...
import it.iubar.json.JsonValidator;
	...
	public class PagheOpenJsonTest {
		...
		private static void init() throws MalformedURLException, IOException {
			PagheOpenJsonTest.schemaFile = new File(
					PagheOpenJsonTest.class.getResource(schemaFilename).getFile());
		}
		...
		public void testPoSchema() throws IOException {
			...
			File schemaFile = new File(
					PagheOpenJsonTest.class.getResource("/po/draft7-schema.json").getFile());			
